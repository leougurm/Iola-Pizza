...
const DEFAULT_SETTINGS: SiteSettings = {
  ...
  aboutDescription: '2010 yilinda Izmir Goztepe\'de kucuk bir dukkanda baslayan seruvenimiz, Erhan Usta\'nin tutkusuyla bugun sehrin en sevilen pizza duragi haline geldi.',
    ...
    <div className="pt-20 bg-white min-h-screen">
      ...
      <div className="relative h-[400px] flex items-center justify-center">
        <div className="absolute inset-0">
          <img
            src={settings.aboutImage1 || "https://images.unsplash.com/photo-1556910103-1c02745a30bf?auto=format&fit=crop&w=1920&q=80"}
            alt="İolo Pizza Mutfak"
            className="w-full h-full object-cover brightness-50"
          />
        </div>
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-5xl md:text-6xl font-display font-bold mb-4">{settings.aboutTitle}</h1>
          <p className="text-xl max-w-2xl mx-auto font-light">{settings.aboutSubtitle}</p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-red/10 text-brand-red rounded-full">
              <ChefHat size={20} />
              <span className="font-bold uppercase text-sm tracking-wide">Hakkımızda</span>
            </div>
            <h2 className="text-4xl font-display font-bold text-brand-dark">{settings.aboutSubtitle}</h2>
        ...
        <div className="bg-brand-cream rounded-3xl p-12 md:p-20">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center space-y-4">
              ...
              <h3 className="font-bold text-xl text-brand-dark">{settings.feature1Title}</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="font-bold text-xl text-brand-dark">{settings.feature2Title}</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="font-bold text-xl text-brand-dark">{settings.feature3Title}</h3>
              <p className="text-gray-600">
